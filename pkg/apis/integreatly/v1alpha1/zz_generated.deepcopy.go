...
func (in *BlobStorageSpec) DeepCopyInto(out *BlobStorageSpec) {
	*out = *in
	if in.ResourceTypeSpec != nil {
		in, out := &in.ResourceTypeSpec, &out.ResourceTypeSpec
...
func (in *BlobStorageStatus) DeepCopyInto(out *BlobStorageStatus) {
	*out = *in
	if in.ResourceTypeStatus != nil {
		in, out := &in.ResourceTypeStatus, &out.ResourceTypeStatus
